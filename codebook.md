...
The code pasted in run_analysis.R file in this repository uses UCI HAR Dataset and produces a tidy dataset TidyDataSet.txt. 
This codebook explains the tidy data set

The data set contains data for means and standard deviations of 33 basic features from 30 volunteers (subjects) involved 
in 6 activities. The data summarises averages for each of these features by subjects and activity:
...
More details about features below: The features selected for this database come from the accelerometer and gyroscope
